...
export class FilmpalastTO extends Source {
    ...
    protected override async handleInternal(_ctx: Context, _type: ContentType, id: Id): Promise<SourceResult[]> {
        ...
        try {
            const response = await (this.fetcher.fetch as any)(searchUrl);
            ...
            const streamResponse = await (this.fetcher.fetch as any)(streamPageUrl);
